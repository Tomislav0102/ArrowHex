...
public class RelayManager
{
    ...
    public async Task<Allocation> AllocateRelay() //called by host
    {
        try
        {
          //  Allocation allocation = await RelayService.Instance.CreateAllocationAsync(_maxPlayers - 1, region: "europe-central2"); //host is excluded
    ...
    public async Task ListRelayRegions()
    {
        try
        {
        ...
        {
            Debug.LogError("Failed to fetch Relay regions: " + e.Message);
        }
    }
